        ...
        <main id="main-center">
            ...
            ?>
                <div class="question-content">
                    ...
                    <p class="question">
                        <a class="question-detail-link" href="questionDetail.php?question_id=<?=$row["question_id"]?>&question=<?=htmlspecialchars($row["question"])?>&question_dt=<?=$row["question_dt"]?>&profile=<?=$avatar_url?>&uname=<?=$username?>"><?=$row["question"]?></a>
                    </p>
                </div>
                <?php
                    }
